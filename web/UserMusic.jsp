...
<div class="sidebar">
    ...
    <ul class="nav-menu">
        <li><a href="${pageContext.request.contextPath}/user/music" class="active"><i>🏠</i>首页</a></li>
...
<div class="main-content">
    ...
    <!-- 顶部横幅图片 -->
    <img src="${pageContext.request.contextPath}/images/first.png" alt="首页横幅" class="banner-image">

    <h2 class="section-title">
        <c:choose>
            <c:when test="${not empty keyword}">搜索结果 - "${keyword}"</c:when>
            <c:otherwise>好歌精选</c:otherwise>
        </c:choose>
    </h2>

    <div class="new-songs">
        <c:choose>
            <c:when test="${empty newSongs}">
                <div class="empty-message">
                    <c:choose>
                        <c:when test="${not empty keyword}">
                            <p>未找到相关音乐</p>
                            <p style="margin-top: 10px; font-size: 14px;">试试其他关键词或<a href="${pageContext.request.contextPath}/user/music" style="color: #4CAF50;">浏览全部音乐</a></p>
                        </c:when>
                        <c:otherwise>
                            <p>暂无音乐</p>
                        </c:otherwise>
            ...
            <c:otherwise>
                ...
                <table class="song-list">
                    ...
                    <tbody>
                    <c:forEach var="song" items="${newSongs}" varStatus="status">
